...
<head>
  ...
  <!-- Favicons -->
  <link href="assets/img/android-icon-36x36.png" rel="icon">
  <link href="assets/img/apple-icon-72x72.png" rel="apple-touch-icon">
...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="index.html" class="logo d-flex align-items-center">
        <img src="assets/img/CB Fundraising Logo Dorado.png" alt="">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center" href="#">
               ...
               <a  href="<?php echo $logoutAction ?>"><span class="salir" >Sign Out</span></a>
              </a>
            </li>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#tables-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-layout-text-window-reverse"></i><span>Accumulated points</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
          ...
          <div class="row">
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card revenue-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Raised<span>| This Month</span></h5>
            ...
            <div class="col-xxl-4 col-xl-12">
              ...
              <div class="card info-card customers-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Donors <span>| This Month</span></h5>
  ...
  <footer id="footer" class="footer">
    ...
    <div class="credits">
      ...
      Powered by <a href="https://bootstrapmade.com/">Consulfinhn</a>
    </div>
  </footer><!-- End Footer -->
